...
<div class="bio-visual">
  <div class="bio-intro">
    ...
    <p>My research focuses on human-centric manufacturing, human-robot interaction, human factors and ergonomics, and the human-centric adaptation of robotics.</p>
...
<strong class="bio-section-title">Research Workflow</strong>
<div class="bio-workflow">
  <div class="bio-step">
    <div class="bio-step-number">1</div>
    <strong>Human State Sensing</strong>
    <p>Collect physiological and task-related signals from operators.</p>
  </div>
  <div class="bio-step">
    <div class="bio-step-number">2</div>
    <strong>State Interpretation</strong>
    <p>Translate signals into meaningful human-state understanding.</p>
  </div>
  <div class="bio-step">
    <div class="bio-step-number">3</div>
    <strong>Robot Adaptation</strong>
    <p>Connect human-state awareness with robot behavior and decisions.</p>
  </div>
  <div class="bio-step">
    <div class="bio-step-number">4</div>
    <strong>Adaptive HRC</strong>
    <p>Support safer, more efficient, and more responsive collaboration.</p>
  </div>
</div>
